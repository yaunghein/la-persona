...
<template>
  <section>
    ...
    >
      ...
      <h2
        class="relative mx-auto -mb-5 max-w-[20rem] text-center text-xl font-light uppercase leading-normal tracking-[0.2rem] sm:max-w-160 sm:text-[2.5rem] sm:tracking-[0.3rem]"
      >
